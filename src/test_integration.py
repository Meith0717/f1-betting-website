...
def test_with_real_data():
    ...
    race_results_file = os.path.join(os.path.dirname(__file__), 'app', 'data', 'race_results.json')
        ...
        for i, bet in enumerate(test_bets, 1):
            ...
            if test_results.get('overall_fastest_lap'):
                ...
                actual_results['overall_fastest_lap'] = {
                    ...
                    'teamId': betting_manager.driver_teams.get(fastest_lap_data['driverId'], 'unknown')
                }
            ...
            try:
                ...
                if bet['name'] == "Perfect Podium Test":
                    if result['total_points'] == 8:
                        ...
                        print(f"❌ Perfect podium test failed (got {result['total_points']}/8)")
