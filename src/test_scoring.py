...
def test_scoring_system():
    ...
    print(f"\nScoring Breakdown:")
    print(f"  Position 1: {result_1['breakdown']['position_1']} pts (VER ✅ driver + Red Bull ✅ team)")
    print(f"  Position 2: {result_1['breakdown']['position_2']} pts (ALC ❌, should be HAM)")
    print(f"  Position 3: {result_1['breakdown']['position_3']} pts (RUS ❌, should be LEC)")
    print(f"  Fastest Lap: {result_1['breakdown']['fastest_lap']} pts (HAM ❌, should be VER)")
    print(f"  Perfect Podium: {result_1['breakdown']['perfect_podium']} pts (❌ not all correct)")
    ...
    print(f"Actual:       [VER, HAM, LEC] | Fastest: VER")
    print(f"\nScoring Breakdown:")
    print(f"  Position 1: {result_2['breakdown']['position_1']} pts (VER ✅ + Red Bull ✅)")
    print(f"  Position 2: {result_2['breakdown']['position_2']} pts (HAM ✅ + Mercedes ✅)")
    print(f"  Position 3: {result_2['breakdown']['position_3']} pts (LEC ✅ + Ferrari ✅)")
    print(f"  Fastest Lap: {result_2['breakdown']['fastest_lap']} pts (VER ✅)")
    print(f"  Perfect Podium: {result_2['breakdown']['perfect_podium']} pts (✅ ALL correct!)")
    ...
    user_bet_3 = {
        "drivers": ["sai", "rus", "alc"],  # SAI (Ferrari), RUS (Mercedes), ALC (Aston Martin)
        "fastest_lap": "lec"
    }
    ...
    print(f"\nScoring Breakdown:")
    print(f"  Position 1: {result_3['breakdown']['position_1']} pts (SAI ❌ but Ferrari ✅)")
    print(f"  Position 2: {result_3['breakdown']['position_2']} pts (RUS ❌ but Mercedes ✅)")
    print(f"  Position 3: {result_3['breakdown']['position_3']} pts (ALC ✅ + Aston Martin ✅)")
    print(f"  Fastest Lap: {result_3['breakdown']['fastest_lap']} pts (LEC ❌, should be VER)")
    ...
    print(f"  Position 3: {result_4['breakdown']['position_3']} pts (ALC ❌, should be LEC)")
    print(f"  Fastest Lap: {result_4['breakdown']['fastest_lap']} pts (SAI ❌, should be VER)")
